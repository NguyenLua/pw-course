...
export class LoginPage {
    ...
    //result
    async checkLoginfail(userName: string) {
        await expect(this.page.locator(this.xpathErrorMessage)).toContainText(`The username ${userName} is not registered on this site`);
    }
